...
### Switches
#set_property PACKAGE_PIN V17 [get_ports {red_switch}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {red_switch}]
#set_property PACKAGE_PIN V16 [get_ports {green_switch}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {green_switch}]
#set_property PACKAGE_PIN W16 [get_ports {blue_switch}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {blue_switch}]
#set_property PACKAGE_PIN W17 [get_ports {input_4bit[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {input_4bit[2]}]
#set_property PACKAGE_PIN W15 [get_ports {input_4bit[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {input_4bit[3]}]
...
#set_property PACKAGE_PIN U3 [get_ports {pwm_out[11]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {pwm_out[11]}]
#set_property PACKAGE_PIN P3 [get_ports {pwm_out[12]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {pwm_out[12]}]
#set_property PACKAGE_PIN N3 [get_ports {pwm_out[13]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {pwm_out[13]}]
#set_property PACKAGE_PIN P1 [get_ports {pwm_out[14]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {pwm_out[14]}]
#set_property PACKAGE_PIN L1 [get_ports {pwm_out[15]}]					
